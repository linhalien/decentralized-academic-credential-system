/**
 * contracts.ts
 * Real ABIs from shared/constants.ts (Linh's contracts).
 * Addresses loaded from .env (set by demo.sh after deployment).
 */
...
// Source: shared/constants.ts → REGISTRY_ABI
...
// ─── MerkleVerifier ABI ───────────────────────────────────────────
// Source: shared/constants.ts → VERIFIER_ABI
